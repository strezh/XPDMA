...
proc create_hier_cell_pcie_cdma_subsystem {} {
  ...
  set translation_bram_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 translation_bram_mem ]
  ...
  set axi_pcie_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_pcie:2.9 axi_pcie_1 ]
  ...
  set translation_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 translation_bram ]
...
proc generateSubsystem {migFile projName designName} {
  ...
  set ddr_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:mig_7series:4.2 ddr3_mem ]
